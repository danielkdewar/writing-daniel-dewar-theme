...
After Dark uses Hugo [Theme Components](https://gohugo.io/themes/theme-components/) to provide optional add-on modules for the theme. Each module is packaged as an NPM module for convenience. A summary of available modules with repository links can be found in the following table.
